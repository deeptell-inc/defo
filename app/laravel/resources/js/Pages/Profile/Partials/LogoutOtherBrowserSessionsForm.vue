...
<template>
    <ActionSection>
        ...
        <template #description>
            他のブラウザやデバイスでのアクティブなセッションを管理し、ログアウトします。
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                必要に応じて、すべてのデバイスでの他のブラウザセッションからログアウトできます。最近のセッションの一部は以下に示されていますが、このリストは完全ではない可能性があります。アカウントが侵害されたと感じた場合は、パスワードも更新する必要があります。
            </div>
