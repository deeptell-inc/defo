...
// Routes for general users (guests only)
...
// Routes for web (general user) login
...
// Routes for fp_user login
Route::prefix('fp')->middleware('guest:fp_user')->group(function () {
    Route::get('login', [LoginController::class, 'showFpLoginForm'])->name('fp.login');
